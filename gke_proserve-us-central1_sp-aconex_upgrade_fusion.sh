...
PROVIDER=gke
CLUSTER_NAME=proserve-us-central1
RELEASE=sp-aconex
NAMESPACE=sp-aconex
CHART_VERSION=5.3.5

MY_VALUES=""
MY_VALUES="$MY_VALUES --values gke_proserve-us-central1_sp-aconex_fusion_values.yaml"
MY_VALUES="$MY_VALUES --values gke_proserve-us-central1_sp-aconex_fusion_resources.yaml"
MY_VALUES="$MY_VALUES --values gke_proserve-us-central1_sp-aconex_fusion_affinity.yaml"
